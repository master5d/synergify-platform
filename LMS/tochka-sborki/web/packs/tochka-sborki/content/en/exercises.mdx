...
Open [`automation-recipes.md`](/materials/automation-recipes.md) and pick **one** recipe:
...
After completing the exercises — fill in `my-experiments/feedback-final.md` (copy from [`feedback-final-jtbd.md`](/materials/feedback-final-jtbd.md), 20–30 min).

This is deep reflection on the whole course through the 4 JTBD forces (Push / Pull / Anxieties / Habits) + before/after + ranking edits. Your signal (optional, anonymous) goes through [the feedback form](/en/feedback/) — a key input for the course's evolution.

---

**Quick reference:** [the cheatsheet](/en/cheatsheet/)
