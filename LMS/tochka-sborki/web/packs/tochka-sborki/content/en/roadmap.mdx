...
description: "A path from non-coder to AI generalist — 8 elective topics"
order: 99
duration: ""
level: 0
---
...
| Topic | Focus | Time |
| :--- | :--- | :--- |
| [**Kickstart**](/en/lessons/00-kickstart/) | Orienting in the AI world | 20–30 min |
| [**Introduction**](/en/lessons/01-introduction/) | Software 3.0 and four shifts | 30 min |
| [**Setup**](/en/lessons/02-setup-guide/) | Workspace and tools | 2–3 h |
| [**Stack Selection**](/en/lessons/03-stack-selection/) | Which agentic stack fits your constraints | 60 min |
| [**Prompt Engineering**](/en/lessons/04-prompt-engineering/) | Writing the spec | 1–2 h |
| [**Context & Memory**](/en/lessons/05-context-memory/) | Agent memory | 1 h |
| [**Automation Pipeline**](/en/lessons/06-audio-pipeline/) | Chains of actions | 45 min |
| [**Tools & Extensions**](/en/lessons/07-tools/) | MCP, Skills, Hooks, Superpowers | 2–3 h |
| [**Agent Engineering**](/en/lessons/08-agent-engineering/) | Orchestration, prod infra, ENERV/SOVERN | 90 min |

### 🔭 On the radar

Topics in consideration — a direction, not a final list. Want one sooner? [Tell us via feedback](/en/feedback/) — it moves the priority.

- **Gemini Notebook** (formerly NotebookLM) — working with your own notes as grounded context
...
From a manual prompt to a pipeline that is ready to be automated.

**Units:** Activation · Pipeline theory · Build · Reflection

**Concepts:**
- Trigger → Action and three questions before you build: trigger, action, condition (when NOT to run)
- Three pipeline types: manual, scheduled, event-driven — and how to pick one for the task
- The path from manual to automated: a manual run as a draft first, then conditions, a schedule, notifications
- The automation map: what you can delegate to a pipeline and what stays with a human

**Tools:** Claude (claude.ai or Claude Code), any agent that can scrape a page; Zapier/Make/n8n and Hooks as an overview

**Projects:**
- Design and run by hand your first URL → insights pipeline, ready to be automated
- A reusable prompt and your run results in `my-experiments/`
- A list of candidate tasks to automate — your plan for the next modules
...
Five clone candidates (see [Introduction](/en/lessons/01-introduction/)):
...
- **Power to Automate with AI** — claw back, by the author's estimate, 5–15 hours a week from routine
