  ...
  ru: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Что если мне не с кем собрать круг?', a: 'Это нормально и никуда не торопит. Практика первых семи шагов работает и в одиночку — а восьмой шаг останется рядом до момента, когда трое-семеро живых людей найдутся. Искать их можно и в Telegram-чате академии «Мастерская Перехода» (t.me/kundaliniRUs/7823), тема «Тишина».' },
  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'What if I have no one to form a circle with?', a: 'That is normal, and nothing hurries you. The practice of the first seven steps works alone — and step eight will stay right here until three to seven living people are found. You can also look for them in the academy\'s Telegram chat "Мастерская Перехода" (t.me/kundaliniRUs/7823), topic «Тишина».' },
