  ...
  ru: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Что если мне не с кем собрать круг?', a: 'Это нормально и никуда не торопит. Практика первых семи шагов работает и в одиночку — а восьмой шаг останется рядом до момента, когда трое-семеро живых людей найдутся. Искать их можно и в Telegram-чате академии «Мастерская Перехода» (t.me/kundaliniRUs), тема «Тишина».' },
