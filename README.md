...
сохранена). Спека: docs/superpowers/specs/2026-08-06-synergify-platform-extraction-design.md
...
Cutover Ф0.5: CI включён; секрет CLOUDFLARE_API_TOKEN добавляется owner'ом в repo secrets.
